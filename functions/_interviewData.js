  ...
  "Y7M4QK2R8VLA": {
    ...
    "customQuestions": [
      ...
      },
      {
        ...
        "number": "1",
        "label": "Task 3-A에서 창가 좌석을 예매해야 하는 상황이었는데 바로 ‘예매’ 버튼을 누르셨습니다. 그때 자동 배정되는 좌석이 창가 좌석인지 확인할 수 있다고 생각하셨나요?"
      },
      {
        "group": "Task 3-A / Task 3-B",
        "number": "2",
    ...
    "customQuestions": [
      {
        "group": "Task 1-A",
        "number": "1",
        "label": "Task 1-A에서 처음에 ‘예매’ 버튼을 눌렀다가 바로 돌아오셨는데, 그때 ‘예매’ 버튼이 어떤 기능이라고 생각하셨나요?"
      },
      {
        "group": "Task 1-A",
        "number": "2",
        "label": "이후에는 비교적 순조롭게 진행하셨는데, 설문 점수를 낮게 주신 이유는 무엇인가요?"
      },
      {
