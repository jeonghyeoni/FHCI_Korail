    ...
    <main className="phone-frame intro-frame" data-clarity-unmask="true">
      <section className="screen consent-screen">
        ...
        <section className="consent-card">
          <h2>연구 윤리</h2>
          <p>
            본 프로토타입은 개인정보 입력을 필수로 요구하지 않습니다. 마지막 종합 설문에서 전화번호를 선택적으로 기재할 수 있으며,
            이 정보는 필요 시 추가 설문 연락 및 기프티콘 지급 안내 목적으로만 사용됩니다. 수집 데이터는 FHCI 수업 내 사용성 분석 목적으로만 사용되며,
