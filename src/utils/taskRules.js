export function isTargetSeat(taskId, seat) {
  ...
  if (taskId === "2") return seat.carriageNo === 5 && seat.label === "8D";
...
export function getSeatMisclickReason(taskId, seat) {
  ...
  if (taskId === "2" && !(seat.carriageNo === 5 && seat.label === "8D")) {
...
export function getAutoSeat(taskId, seats) {
  ...
  if (taskId === "2") {
    return availableSeats.find((seat) => seat.carriageNo === 5 && seat.label === "8D") || availableSeats[0];
  }
  if (taskId === "3") {
